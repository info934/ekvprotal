...
export const PORTAL_NAVIGATION = [
  ...
  { label: 'Firma', items: [
    ...
    { label: 'Zaměstnanci', path: '/members', icon: Users },
...
export const getPortalSection = (pathname) => pathname === '/employee' || pathname.startsWith('/employees/') ? { label: 'Zaměstnanci', path: '/members' } : ALL_PORTAL_NAVIGATION
