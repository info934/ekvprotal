        ...
        <div>
            ...
            <div className="app-page-wide">
                <Tabs value={activeTab} onValueChange={openTab} className="space-y-4">
                    ...
                    <TabsContent value="meetings"><MeetingNotes entityTitle={project.name} entityCode={project.code} entityType="project" entityId={projectId} canEdit={canEdit} onOpenPlan={() => openTab('plan')} /></TabsContent>
